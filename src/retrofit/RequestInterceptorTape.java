...
/**
 * Records methods called against it as a RequestFacade and replays them when
 * called as a RequestInterceptor.
 */
final class RequestInterceptorTape implements RequestInterceptor.RequestFacade,
	...
	public void addEncodedPathParam(String name, String value) {
		tape.add(new CommandWithParams(Command.ADD_ENCODED_PATH_PARAM, name,
				value));
	}
	...
	public void addEncodedQueryParam(String name, String value) {
		tape.add(new CommandWithParams(Command.ADD_ENCODED_QUERY_PARAM, name,
				value));
	}
	...
	private enum Command {
		ADD_HEADER {
			@Override
			public void intercept(RequestFacade facade, String name,
					String value) {
